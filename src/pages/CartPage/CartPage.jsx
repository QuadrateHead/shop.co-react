...
const CartPage = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="cart-page">
        <h1 className="cart-page__heading h-">Your Cart</h1>
  ...
  return (
    <div className="cart-page">
      <PagePath stylePath={"path"}></PagePath>
      ...
      <div className="cart-page__block">
                ...
                <div className="cart-item__content">
                  <div className="cart-item__header">
                    ...
                    <button
                      ...
                      onClick={() => removeFromCart(item.id, item.color.color, item.size)}
                    >
                  ...
                  <div className="cart-item__price">
                    ...
                    <div className="cart-item__amount">
                      <button
                        onClick={() =>
                          updateCartItemAmount(item.id, item.color.color, item.size, item.amount - 1)
                        }
                      >
        ...
        <OrderSummary
          subtotal={totalPrice}
          onCheckout={() => {
            // navigate to checkout page / trigger checkout logic
          }}
        />
      </div>
