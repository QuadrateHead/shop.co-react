    ...
    <div className='prdctreviews'>
      <div className="prdctreviews__header">
        <div className="prdctreviews__allreviews">
          ...
          <p className="prdctreviews__allreviews-count">{`(${reviews.length})`}</p>
        </div>
        <div className="prdctreviews__conf">
          ...
          <select value={sortValue} onChange={(e) => setSortValue(e.target.value)} className="prdctreviews__sort">
      ...
      <div className="prdctreviews__grid">
        {sortedReviews.map((review) => (
          <div key={review.date} className="prdctreviews__review-card">
            <div className="prdctreviews__header">
